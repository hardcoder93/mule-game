 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Yuna Lee");
		  toPrint += p1.toString("902804550");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Chris Jenkins");
		  toPrint += p2.toString("902746852");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Sung Hye Jeon");
		  toPrint += p3.toString("902826885");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("John Certusi");
          toPrint += p4.toString("902354283");
		  //Person5 replace P5 with your name
          //and ggg000x with your gt num
          Person5 p5 = new Person5("WongooShim");
          toPrint += p5.toString("902904259");
